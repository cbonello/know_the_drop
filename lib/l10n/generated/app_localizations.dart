...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'How well do you know the legend?'**
  ...
  /// No description provided for @categoryDiscography.
  ///
  /// In en, this message translates to:
  /// **'Discography'**
  String get categoryDiscography;
  ...
  /// No description provided for @categoryEdmCulture.
  ///
  /// In en, this message translates to:
  /// **'EDM culture'**
  String get categoryEdmCulture;
  ...
  /// No description provided for @difficultyCasualFan.
  ///
  /// In en, this message translates to:
  /// **'Casual fan'**
  String get difficultyCasualFan;

  /// No description provided for @difficultyTrueFan.
  ///
  /// In en, this message translates to:
  /// **'True fan'**
  String get difficultyTrueFan;

  /// No description provided for @difficultyScholar.
  ///
  /// In en, this message translates to:
  /// **'Scholar'**
  String get difficultyScholar;

  /// No description provided for @yourBestScore.
  ///
  /// In en, this message translates to:
  /// **'Your best score'**
  ...
  /// No description provided for @quitConfirmYes.
  ///
  /// In en, this message translates to:
  /// **'Quit'**
  String get quitConfirmYes;

  /// No description provided for @quitConfirmNo.
  ///
  /// In en, this message translates to:
  /// **'Continue'**
  String get quitConfirmNo;
